        ...
        <main>
            <div class="container-xl">
                <div class="table-responsive">
                    <!-- print button -->
                    <a href="generate_pdf.php?id=<?php echo $userid ?>&ticket=<?php echo $ticket ?>" class="btn btn-success" target="_blank" style="margin-bottom: 5px;"><i class="fa" data-toggle="tooltip" title="Print">&#128438;</i>PRINT</a>
                    ...
                    <div class="table-wrapper">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h2 align="center">MIS-Asset Transmittal <b>Form</b></h2>
                                </div>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr>";
                                        echo "<td style='width: 30%;'>$hardware</td>";
                                        echo "<td style='width: 30%;'>$serialnum</td>";
                                        echo "<td style='width: 10%;'>$qty</td>";
                                        echo "<td style='width: 30%;'>$comment</td>";
